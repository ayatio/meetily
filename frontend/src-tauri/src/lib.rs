...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            otto::participants::otto_set_meeting_participants,
            otto::participants::otto_get_meeting_participants,
            otto::participants::otto_list_known_participants,
